...
console.log("EstudianteService:", proto.EstudianteService); 

if (!proto.EstudianteService) {
    throw new Error("EstudianteService no está definido en el proto. Revisa la carga del proto y el package.");
}
